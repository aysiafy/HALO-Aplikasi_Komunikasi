...
public class Login extends javax.swing.JFrame {
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        ...
        frm.setDefaultCloseOperation(Register.EXIT_ON_CLOSE);
    }//GEN-LAST:event_jLabel7MouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        usr.username = tf_username.getText().toLowerCase().trim();
        usr.password = tf_password.getText().toString();

        if (usr.cekLogin() == 1) {
            this.setVisible(false);
            Home frm = new Home(usr.username, usr.password);
            frm.setVisible(true);
            frm.pack();
            frm.setLocationRelativeTo(null);
            frm.setLocation(500, 150);
            frm.setSize(376, 450);
            frm.setResizable(false);
            frm.setDefaultCloseOperation(Home.EXIT_ON_CLOSE);
        } else if (usr.cekLogin() == 2){
            this.setVisible(false);
            Admin frm = new Admin(usr.username, usr.password);
            frm.setVisible(true);
            frm.pack();
            frm.setLocationRelativeTo(null);
            frm.setLocation(500, 150);
            frm.setSize(376, 450);
            frm.setResizable(false);
            frm.setDefaultCloseOperation(Admin.EXIT_ON_CLOSE);
        } else {
